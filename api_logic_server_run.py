...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.01.18, July 24, 2023 18:29:30):
...
app_logger.info(f'Created July 24, 2023 18:29:30 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 09.01.18\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 09.01.18\n'
    if is_docker():
